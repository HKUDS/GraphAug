...
def get_dataset(path, name):
        assert name in ['Cora', 'CiteSeer', "AmazonC", "AmazonP", 'CoauthorC']
        if name =="DBLP":
            name = "dblp"
        # if name == "AmazonC":
        ...
        return (CitationFull if name == 'dblp' else Planetoid)(path,name,"public",T.NormalizeFeatures())
